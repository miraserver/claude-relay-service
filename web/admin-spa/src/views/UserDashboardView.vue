        ...
        <div class="flex h-16 justify-between">
          ...
          <div class="flex items-center space-x-4">
            <div class="text-sm text-gray-700 dark:text-gray-300">
              {{ $t('user.welcome') }}, <span class="font-medium">{{ userStore.userName }}</span>
            </div>
          ...
          <div class="px-4 py-5 sm:p-6">
            ...
            <div class="mt-5 border-t border-gray-200 dark:border-gray-700">
              <dl class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {{ $t('user.account.displayName') }}
                  </dt>
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0">
                    {{ userProfile?.displayName || $t('user.account.na') }}
                  </dd>
                </div>
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                  ...
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0">
                    {{ userProfile?.email || $t('user.account.na') }}
                  </dd>
                </div>
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                ...
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                  <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {{ $t('user.account.lastLogin') }}
                  </dt>
                  <dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0">
                    {{ formatDate(userProfile?.lastLoginAt) || $t('user.account.na') }}
                  </dd>
                </div>
              </dl>
            </div>
...
const handleLogout = async () => {
  try {
    ...
    showToast(t('errors.general.unknown'), 'error')
  }
}
