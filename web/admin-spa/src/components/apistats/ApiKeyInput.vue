  ...
  <div class="api-input-wide-card mb-8 rounded-3xl p-6 shadow-xl">
    ...
    <div class="wide-card-title mb-6">
      <h2 class="mb-2 text-2xl font-bold text-gray-900 dark:text-gray-200">
        ...
        {{ $t('apistats.input.title') }}
      </h2>
      <p class="text-base text-gray-600 dark:text-gray-400">{{ $t('apistats.input.subtitle') }}</p>
    </div>
    ...
    <div class="mx-auto max-w-4xl">
      ...
      <div class="control-bar mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          {{ multiKeyMode ? $t('apistats.input.labelMulti') : $t('apistats.input.labelSingle') }}
        </label>
        ...
        <div class="button-group flex items-center gap-2">
          ...
          >
            <button
              ...
              :title="$t('apistats.input.modeSingle')"
              @click="multiKeyMode = false"
            >
              <i class="fas fa-key" />
              <span class="ml-2 hidden sm:inline">{{ $t('apistats.input.modeSingleShort') }}</span>
            </button>
            <button
              class="mode-switch-btn"
              :class="{ active: multiKeyMode }"
              :title="$t('apistats.input.modeMulti')"
              @click="multiKeyMode = true"
            >
              <i class="fas fa-layer-group" />
              <span class="ml-2 hidden sm:inline">{{ $t('apistats.input.modeMultiShort') }}</span>
              <span
      ...
      <div class="api-input-grid grid grid-cols-1 gap-4 lg:grid-cols-4">
        ...
        <div class="lg:col-span-3">
          ...
          <input
            ...
            :disabled="loading"
            :placeholder="$t('apistats.input.placeholderSingle')"
            type="password"
          ...
          <div v-else class="relative">
            <textarea
              ...
              :disabled="loading"
              :placeholder="$t('apistats.input.placeholderMulti')"
              rows="4"
            ...
            <button
              ...
              :title="$t('apistats.input.clearInput')"
              @click="clearInput"
            >
        ...
        <div class="lg:col-span-1">
          ...
          >
            ...
            {{ loading ? $t('apistats.input.querying') : $t('apistats.input.queryButton') }}
          </button>
        </div>
      </div>
      ...
      <div class="security-notice mt-4">
        ...
        {{
          multiKeyMode
            ? $t('apistats.input.securityNoticeMulti')
            : $t('apistats.input.securityNoticeSingle')
        }}
      </div>
      ...
      >
        ...
        <span>{{ $t('apistats.input.multiKeyHint') }}</span>
      </div>
    </div>
  </div>
</template>
